    ...
    <div className="min-h-screen bg-background flex items-center justify-center p-4">
      <div className="w-full max-w-sm">
        ...
        >
          <button
            type="submit"
            className="brutalist-btn w-full bg-blue-primary text-white font-bold py-4 px-6 flex items-center justify-center gap-3 text-sm uppercase tracking-wider"
          >
